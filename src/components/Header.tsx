  ...
  return (
    <header className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      <div className="flex items-center cursor-pointer hover:opacity-80 transition-opacity">
        <BrainCircuit size={28} className="text-indigo-600 dark:text-indigo-400 mr-2 animate-pulse duration-2000" />
        <h1 className="text-2xl font-bold bg-gradient-to-r from-indigo-600 via-purple-500 to-teal-500 bg-clip-text text-transparent hover:shadow-lg transition-all">
          Zenith
        </h1>
      </div>
