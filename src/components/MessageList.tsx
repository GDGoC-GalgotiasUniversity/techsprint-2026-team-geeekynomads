      ...
      <div className="flex-1 overflow-y-auto">
        <div className="flex items-center justify-center p-4 text-gray-500 dark:text-gray-400">
          <div className="text-center max-w-md">
            <BrainCircuit size={48} className="mx-auto mb-4 text-indigo-500 dark:text-indigo-400" />
            <h2 className="text-2xl font-bold mb-2">Welcome to Zenith</h2>
            <p className="text-sm text-gray-400 dark:text-gray-500 mb-4">by Geeky Nomads</p>
            <p className="mb-4">
              Your intelligent AI assistant powered by cutting-edge technology. I can help with research, explain concepts, summarize information, brainstorm ideas, and much more.
            </p>
            <p className="mb-6 text-sm">Choose a template below or type your own message to get started.</p>
          </div>
        </div>
        <PromptTemplates />
      </div>
